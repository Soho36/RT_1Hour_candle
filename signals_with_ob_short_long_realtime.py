...
def hourly_engulf_signals(
    ...
    for index, row in output_df.iterrows():
        ...
        for subsequent_index in range(index + 1, len(output_df)):
            ...
            potential_ob_doji = (potential_ob_body * 100) / (potential_ob_candle_high - potential_ob_candle_low)
            ...
            if potential_ob_candle_close > potential_ob_candle_open:
                ...
                if potential_ob_candle_high - potential_ob_candle_low <= ob_candle_size:
